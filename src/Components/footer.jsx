...
export default function Footer() {
  return (
    <>
      <footer className="bg-semi-gray w-full py-4 flex-col justify-center items-center  ">
        <div className="w-full container px-8 flex flex-wrap justify-between py-8">
          <div className=" w-full md:w-1/3 lg:w-4/12 xl:w-4/12  ">
            <ul className="py-4 text-white font-normal ">
              ...
              <li className="mb-2 text-white hover:text-secondary ">
                Tafroute
              </li>
              <li className="mb-2 text-white hover:text-secondary">
                <Link>1234523234</Link>
              </li>
              <li className="mb-2 text-white hover:text-secondary">
                <Link to={"/"}>info@tafrout.com</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="w-full md:w-1/3 lg:w-2/12 xl:w-2/12">
            <ul className="py-3  font-normal ">
              <li className="mb-8 font-bold text-2xl text-white">
                Useful Links
              </li>
              <li className="mb-2 text-white hover:text-secondary">
                <Link to={"/"}>Home</Link>{" "}
          ...
          <div className="w-full md:w-1/3 lg:w-2/12 xl:w-2/12 py-4">
            ...
            <div>
              ...
              <div className=" w-10/12 lg:w-full xl:w-full md:w-full flex justify-between mt-6 ">
                <div className="bg-gray-500 w-10 h-10 flex justify-center items-center rounded hover:bg-gray-600 ">
                  <Link>
                    <svg
                      className=" w-5 h-5"
          ...
          <div className="w-full text-white px-6 py-10 font-normal border-t flex flex-wrap  justify-between items-center">
            <div className="w-full text-center mb-4 lg:w-3/12 xl:2/12 text-white ">
              © All rights reserved 2024
            </div>
            <div className="w-full text-center lg:w-3/12 xl:2/12 mb-12 text-white"></div>
          </div>
        </div>
      </footer>
    </>
