    ...
    <>
      <div className="">
          ...
          <div className=" mb-10 flex flex-col lg:flex-row gap-3">
            <div className="relative lg:ps-10 lg:max-w-[60%] ">
              ...
              <div>
                ...
                <h4 className="text-3xl mb-2 font-semibold">Tafraout</h4>
                <p className="text-lg">
            ...
            <div className="flex flex-col mt-10 w-fit gap-4">
              <Link className="flex items-start gap-3 border-transparent border border-b-gray-400 pb-2">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="font-semibold">1231417890</p>
                </div>
              </Link>
              <Link className="flex items-start gap-3 border-transparent border border-b-gray-400 pb-2">
                <svg
        ...
        >
          <div>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3464.9329195339383!2d-8.971753500000002!3d29.721702299999997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xdb6b154c9b108b3%3A0xdd6c8fe508476d33!2z2YXYsdmD2LIg2KfZhNi12K3ZiiDYqtin2YHYsdin2YjYqg!5e0!3m2!1sen!2sma!4v1713442148046!5m2!1sen!2sma"
