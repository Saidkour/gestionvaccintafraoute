...
function HomeHeader() {
  return (
    <div className="block relative pt-20 ">
      <div className='absolute top-0 left-0 w-full h-full bg-[url("/headerImg4.jpg")] opacity-[0.95]  bg-cover bg-center z-[-1]'></div>
      ...
      <div className="flex m-auto ">
        <div className="container mt-[100px] lg:mt-[150px]  px-10">
          ...
          <div>
            <div className="mb-5 text-semi-white">
              <h1 className="bold text-[30px] text-semi-white  md:text-[48px] leading-tigh">
                Centre Hospitale De Tafraoute
              </h1>
            </div>
          </div>
          <div className="text-semi-white mb-10 ">
            <p className="sm:max-w-[100%] max-w-[75%] lg:max-w-[50%] sm:text-[16px] text-semi-white">
              Le centre hospitalier de Tafraout est un établissement médical
              essentiel situé au cœur de la ville, offrant des services de santé
              de qualité à la population locale et aux visiteurs. Doté d'une
              équipe médicale compétente et dévouée, le centre propose une gamme
              complète de soins allant des consultations de routine aux
          ...
          <div>
            <Link
              to={"/contact"}
              className="rounded font-medium text-white hover:text-primary  bg-primary mb-3 px-8 py-3 max-w-[150px]  hover:bg-slate-100   transition duration-500 ease-in-out "
            >
              Contact Us
            </Link>
          </div>
